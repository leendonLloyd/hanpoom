...
import { PickingSlipDates } from "./picking-slip-dates.model";
...
export class PickingSlips {
  ...
  @JoinColumn({
    name: "id",
    referencedColumnName: "picking_slip_id",
    foreignKeyConstraintName: "FK_picking_slip_items_picking_slip_id",
  })
  picking_slip_items: PickingSlipItems[];

  @OneToOne(() => PickingSlipDates, (slip_dates) => slip_dates.picking_slip)
  @JoinColumn({
    name: "id",
    referencedColumnName: "picking_slip_id",
    foreignKeyConstraintName: "FK_picking_slip_dates_picking_slip_id",
  })
  picking_slip_dates: PickingSlipDates;
}
